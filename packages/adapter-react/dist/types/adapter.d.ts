 ...
 */
export declare function useKensho<
...
>(
  ...
  field: {
    (
      ...
      value?: import('@kensho/form').FormElementValue
    ): import('@kensho/form').FormField
    (element: Partial<FormElement>): import('@kensho/form').FormField
  }
  getValue: (
    name: KeyOfAny<Path<T>>,
    cast?: boolean | import('@kensho/form').CoerceHandler | undefined
  ) => import('@kensho/form').FormElementValue
  getValues: (canTransform?: boolean | undefined) => Required<
    T & {
      [key: string]: unknown
    }
  >
  ...
  validate: {
    <U_1 extends Record<string, unknown>>(values: U_1): Promise<
      import('@kensho/form').ErrorState<
        T & {
          [key: string]: unknown
        },
        F
      >
    >
    (names?: KeyOfAny<Path<T>> | KeyOfAny<Path<T>>[] | undefined): Promise<
      import('@kensho/form').ErrorState<
        T & {
          [key: string]: unknown
        },
  ...
  getNativeValidators: (
    ...
    | import('@kensho/form').NativeValidatorAttributes[]
  reset: <
    U_2 extends Record<string, unknown> = T & {
      [key: string]: unknown
    }
  >(
    values?: U_2 | undefined,
    replaceDefaults?: boolean | undefined
  ) => Promise<void>
