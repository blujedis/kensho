...
export declare function createValidators<T extends Record<string, Record<string, CreateValidatorHandler>>, O extends ValidatorOptions = {
    depth: 0;
    flatten: false;
}>(validators?: T, options?: ValidatorOptions): Api<T> & {
