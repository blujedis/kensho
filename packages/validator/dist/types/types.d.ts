...
export declare type CreateValidatorHandler = (
  ...args: any
) => (value: any, data?: Record<string, unknown>) => ValidatorReturnType;
...
export declare type ParseHandler = (
  value: any,
...
export declare type FromApiConfig<
  P extends string,
  T extends Record<string, Record<string, CreateValidatorHandler>>
> = Record<P, ApiConfig<T>>;
export declare type SingleParam = string | number | boolean;
export declare type FromObjectItemParams<
...
>;
export declare type FromObjectItem<
  T extends Record<string, Record<string, CreateValidatorHandler>>,
  K extends keyof T = keyof T
> = {
  type: K;
