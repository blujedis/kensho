...
export declare const COERCE_MAP: {
  ...
  array: (
    ...
    | NumberConstructor
    | ((v: unknown) => unknown)
    | ((v: unknown, places?: number) => unknown)
    | ((v: unknown) => unknown)
    | ((v: unknown) => boolean)
    | ((v: unknown) => unknown)
  )[];
 ...
 */
export declare function parseDataType(
...
export declare function castDataType(
  dataType: DataType,
  dataTypeOptions: any[],
  value: any
): any;
 ...
 */
export declare function recurseNode(
  node: Node,
  validNodes?: string[],
  depth?: number
): Node[];
 ...
 */
export declare function createMutationObserver(
  rootNode: Node,
 ...
 */
export declare function canPlaceholder(
  el: FormElement,
