...
export type TransformHandler<T extends Record<string, unknown>> = (
	values: T
...
export type CoerceHandler = (
	key: string,
	value: FormElementValue,
	options: { dataType: any; dataTypeOptions: any[] }
) => FormElementValue;
...
export type FormAdapterOptions<
	T extends Record<string, unknown>,
	F extends boolean = false
